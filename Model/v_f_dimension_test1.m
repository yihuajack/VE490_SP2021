...
%%% design parameters %%%
%%% test 1 %%%
L = [60e-6,30e-6,12e-6,6e-6, 50e-6,25e-6,10e-6,5e-6];  % large electrode length
S = [30e-6,15e-6,6e-6,3e-6, 30e-6,15e-6,6e-6,3e-6, ]; % small electrode length
G = [20e-6,10e-6,4e-6,2e-6, 20e-6,10e-6,4e-6,2e-6, ]; % inter electrode gap
...
legend({'60-30-20\mum','30-15-10\mum','12-6-4\mum','6-3-2\mum','50-30-20\mum','25-15-10\mum','10-6-4\mum','5-3-2\mum'},'Location','northwest')
